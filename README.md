...
# csvtomongodb-converter

`csvtomongodb-converter` module is a comprehensive nodejs package to handle csv file  upload  and to convert into your mongoDB database collection. It can be used as node.js library or in browser. Below are some features:
you
...
*  Upload file Easily
*  Converts csv to mongoDB database collection
*  Blazing fast
*  Give flexibility to developer with 'pre-defined' helpers



# csvtomongodb-converter online 

[Here](http://keyangxiang.com/csvtojson/) is a free online csv to mongodb convert service utilizing latest `csvtojson` module.
...
```
npm i --save csvtomongodb-converter
```
